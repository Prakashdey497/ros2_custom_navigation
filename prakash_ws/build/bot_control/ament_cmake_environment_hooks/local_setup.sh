...
: ${AMENT_CURRENT_PREFIX:="/home/pdey/my_learning/Ros/prakash_ws/install/bot_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bot_control/environment/pythonpath.sh"
